            ...
            <div class="product-container">
                <div class="product-gallery">
                    <div class="main-image-slider">
                        <div><img src="{{asset('uploads/banner/banner1.jpeg')}}" alt="Nike ACG Hoodie" class="main-image"></div>
                        <div><img src="{{asset('uploads/banner/banner2.jpeg')}}" alt="Back View" class="main-image"></div>
                        <div><img src="{{asset('uploads/banner/banner3.jpeg')}}" alt="Detail View" class="main-image"></div>
                        <div><img src="{{asset('uploads/banner/banner4.jpeg')}}" alt="Detail View" class="main-image"></div>
                        <div><img src="{{asset('uploads/banner/banner5.jpeg')}}" alt="Detail View" class="main-image"></div>
                    </div>
    
                    <div class="thumbnail-slider">
                        <div><img src="{{asset('uploads/banner/banner1.jpeg')}}" alt="Front Thumbnail"></div>
                        <div><img src="{{asset('uploads/banner/banner2.jpeg')}}" alt="Back Thumbnail"></div>
                        <div><img src="{{asset('uploads/banner/banner3.jpeg')}}" alt="Detail Thumbnail"></div>
                        <div><img src="{{asset('uploads/banner/banner4.jpeg')}}" alt="Detail Thumbnail"></div>
                        <div><img src="{{asset('uploads/banner/banner5.jpeg')}}" alt="Detail Thumbnail"></div>
                    </div>
                </div>
