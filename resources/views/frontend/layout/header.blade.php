                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <div class="account me-5">
                            <a title="login" href="#"><span>Login</span><i
                                    class="fa-regular fa-user ms-2"></i></a>
                        </div>
                        <div class="account d-flex">
                            <a href="#" title="Cart">
                                <div class="cart">
                                    <span>Cart</span> <svg xmlns="http://www.w3.org/2000/svg" width="22"
                                        height="22" fill="currentColor" class="bi bi-cart3 mb-1" viewBox="0 0 16 16">
                                        <path
