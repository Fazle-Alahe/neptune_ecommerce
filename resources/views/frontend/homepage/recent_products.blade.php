    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-3">
                <div class="product">
                    <div class="product-image">
                        <a href="#"><img src="{{ asset('uploads/banner/banner5.jpeg') }}" alt=""></a>
                        <div class="discount-badge text-center">
                            <span>-17%</span>
                        </div>
                        <div class="category-badge text-center">
            ...
            <div class="col-lg-3">
                <div class="product">
                    <div class="product-image">
                        <a href="#"><img src="{{ asset('uploads/banner/banner4.jpeg') }}" alt=""></a>
                        <div class="discount-badge text-center">
                            <span>-17%</span>
                        </div>
                        <div class="category-badge text-center">
            ...
            <div class="col-lg-3">
                <div class="product">
                    <div class="product-image">
                        <a href="#"><img src="{{ asset('uploads/banner/banner3.jpeg') }}" alt=""></a>
                        <div class="discount-badge text-center">
                            <span>-17%</span>
                        </div>
                        <div class="category-badge text-center">
            ...
            <div class="col-lg-3">
                <div class="product">
                    <div class="product-image">
                        <a href="#"><img src="{{ asset('uploads/banner/banner2.jpeg') }}" alt=""></a>
                        <div class="discount-badge text-center">
                            <span>-17%</span>
                        </div>
                        <div class="category-badge text-center">
